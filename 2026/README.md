...
Welcome to **REST League 2026**, the 1<sup>st</sup> edition of the ultimate competition for automated **black-box testing** tools designed for **RESTful APIs**.
...
REST League 2026 will be hosted by [SBFT@ICSE2026](https://search-based-and-fuzz-testing.github.io/sbft26) in Rio de Janeiro, Brazil, with the following schedule.
